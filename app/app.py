...
async function guestLogin() {
  ...
  window.location.href = "/chat"; // open chat directly
}
...
function startPolling(sid){
  ...
  poll=setInterval(async()=>{
    ...
    if(j.authenticated){clearInterval(poll);clearInterval(expire);
      closeQR();alert('Lightning login success!');window.location.href='/chat';}
  },2000);
}
...
async function loginWithNostr(){
  ...
  if(j2.verified){alert('Nostr login success!');window.location.href='/chat';}
...
<div class="main-grid">
  <div class="panel" id="homePanel">
    <h2 style="font-size:0.7rem; line-height:1.2; color:#00ff00; font-family:monospace; font-weight:800;">
      <a href="https://github.com/alnostru/demo.git" target="_blank" style="color:#00ff00; text-decoration:none;">
...
def _verify_lnurl_sig(k1_hex: str, sig_hex: str, key_hex: str) -> bool:
    ...
    try:
        ...
        print(f"[LNURL-Auth] verify → {verified}")
        return verified
    except Exception as e:
        print("[LNURL-Auth] verify error:", e)
        return False
...
class OAuthServer:
    ...
    def token_endpoint(self,
        ...
        if grant_type == "authorization_code":
            ...
            return self._handle_code_grant(code, client)
        ...
        <div class="container">
            <div class="cta-box">
                ...
                <div class="cta-buttons-large">
                    <a href="mailto:alnostruniverse@gmail.com" class="white-button">E-mail</a>
